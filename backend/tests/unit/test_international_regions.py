...
import pytest
from src.models.visited_place import RegionType, get_region_total, is_international_region, is_subnational_region
...
class TestInternationalRegionHelpers:
    ...
    def test_region_totals_consistency(self):
        ...
        from src.models.international_regions import REGION_TOTALS as INTERNATIONAL_TOTALS
        
        assert VISITED_PLACE_TOTALS[RegionType.AUSTRALIAN_STATE] == INTERNATIONAL_TOTALS["AU"]
        assert VISITED_PLACE_TOTALS[RegionType.MEXICAN_STATE] == INTERNATIONAL_TOTALS["MX"]
        assert VISITED_PLACE_TOTALS[RegionType.BRAZILIAN_STATE] == INTERNATIONAL_TOTALS["BR"]
        assert VISITED_PLACE_TOTALS[RegionType.GERMAN_STATE] == INTERNATIONAL_TOTALS["DE"]
        assert VISITED_PLACE_TOTALS[RegionType.INDIAN_STATE] == INTERNATIONAL_TOTALS["IN"]
        assert VISITED_PLACE_TOTALS[RegionType.CHINESE_PROVINCE] == INTERNATIONAL_TOTALS["CN"]
...
class TestDataGeneration:
    ...
    def test_sample_data_structure(self):
        ...
        required_fields = [
            ...
            "country_name", "region_type", "iso_3166_2_code"
        ]
